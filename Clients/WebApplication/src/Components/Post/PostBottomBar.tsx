...
const PostBottomBar = ({post}:PostInfo) => {
  return (
    <div className="flex justify-between text-secondary">
        ...
        <button className={"flex gap-1 items-center hover:text-blue"}>
        ...
        <button className={`flex gap-1 items-center hover:text-primary ${post?.isLiked && "text-primary"} `}>
            <svg xmlns="http://www.w3.org/2000/svg" fill={post?.isLiked ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth= {2} stroke="currentColor" className={`size-5`}>
                <path strokeLinecap="round" strokeLinejoin="round" d={post?.isLiked
        ...
        <button className={`flex gap-1 items-center hover:text-cyan ${post?.isBookmarked && "text-cyan"} `}>
            <svg xmlns="http://www.w3.org/2000/svg" fill={post?.isBookmarked ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth= {2} stroke="currentColor" className={`size-5`}>
                <path strokeLinecap="round" strokeLinejoin="round" d={post?.isBookmarked
