...
// import loginValidate from "../Contracts/login.js"; 
import bcrypt from "bcrypt";
// import createJwtToken from "../Application/token.js";    userRead
import * as userModule from "../Infrastructure/user.js";

jest.unstable_mockModule("../Contracts/login.js", () => ({
  default: jest.fn(),
}));

jest.unstable_mockModule("../Application/token.js", () => ({
  default: jest.fn(),
}));

const { default: loginValidate } = await import("../Contracts/login.js");
const { default: createJwtToken } = await import("../Application/token.js");
